...
args.results_folder = os.getcwd() + '/' + 'results/'+'lottery_ticket/'+'B_size-'+str(args.batch_size)+'-Arch-'+str(args.input_dim)+str(args.layer_sizes)+'-iters-'+str(args.max_iterations) + \

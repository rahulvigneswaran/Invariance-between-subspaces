...
print("===============================================================================================")
f = Figlet(font='thin')
print(f.renderText('Invariance layerwise'))
...
args.results_folder = os.getcwd() + '/' + 'results/layerwise/'+'B_size-'+str(args.batch_size)+'-Arch-'+str(args.input_dim)+str(args.layer_sizes)+'-iters-'+str(args.max_iterations)+'-data-'+str(args.data_type)+'-hess_freq-'+str(args.hessian_calc_period)+'-top-'+str(args.top)+'--freq-'+str(args.freq)+'--iter-'+str(args.max_iterations)
